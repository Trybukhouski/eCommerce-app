...
class AboutUsPageUI {
  ...
  createDescriptionDiv(): HTMLElement {
    ...
    handWrittenText.textContent = `Meet Our Dev Dream Team and discover the Secrets to Our Non-Stop Success and read everything carefully if you want to know the secret of our success!`;
